...
public class ExtraLargeGB extends GameBoard {
    public ExtraLargeGB() {
        super();

        typeOfMap = "ExtraLargeGB";
        TILE_SIZE = 20;
        ROWS = 30;
        COLUMNS = 40;
    ...
    protected void setUpBoard(){
        try {
            BufferedReader br = new BufferedReader(new FileReader("src/Boards/TXT/ExtraLargeGB.txt"));
            ...
            for (int i = 0; i < ROWS; ++i) {
                ...
                for (int j = 0; j < COLUMNS; ++j) {
                    if (j < numbers.length) {
                        ...
                        Tile tile = new Tile("ExtraLargeGB", board[i][j], TILE_SIZE);
