...
public class SmallGB extends GameBoard {
    public SmallGB() {
        super();
    ...
    protected void setUpBoard(){
        try {
            BufferedReader br = new BufferedReader(new FileReader("src/Boards/TXT/SmallGB.txt"));
            ...
            for (int i = 0; i < ROWS; ++i) {
                ...
                for (int j = 0; j < COLUMNS; ++j) {
                    if (j < numbers.length) {
                        ...
                        Tile tile = new Tile("SmallGB", board[i][j], TILE_SIZE);
